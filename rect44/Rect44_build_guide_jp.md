...
部品を取り付ける面は左下に「Rect44 v～」と表記されている側です。反対側（スイッチを取り付ける面）にもダイオード用のパッドがありますが無視してください（笑）次ロットから無くします。
...
### ショットキーバリアダイオード
済みません、このキットの中で一番ハンダ付けが難しい部品です。パッド同士をハンダで短絡させないよう注意願います。
...
| ---- |
|プラスマイナスの方向を間違えないようにシルクがある側に電池ボックスを置いて反対側からハンダ付けしてください。ハンダ後は余ったピンをニッパーで切り落としてください。|
...
### 底板
|![bt_plate_01](./img/bt_plate_01.jpg)|![bt_plate_02](./img/bt_plate_02.jpg)|
| ---- | ---- |
